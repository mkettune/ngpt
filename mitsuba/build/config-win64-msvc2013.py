...
CXXFLAGS        = ['/nologo', '/O2', '/fp:fast', '/D', 'WIN32', '/D', 'WIN64', '/W3', '/EHsc', '/GS-', '/GL', '/MD', '/D', 'MTS_DEBUG', '/D', 'DOUBLE_PRECISION', '/D', 'SPECTRUM_SAMPLES=3', '/D',  '_CONSOLE', '/D', 'NDEBUG', '/D', 'OPENEXR_DLL', '/openmp']
SHCXXFLAGS      = CXXFLAGS
TARGET_ARCH     = 'x86_64'
MSVC_VERSION    = '12.0'
...
FFTWLIB         = ['libfftw-3.3']
POISSONSOLVERINCLUDE = ['#dependencies/include/poisson-solver']
POISSONSOLVERLIB 	 = ['poisson']
CUDALIB 	 = ['cudart_static']
